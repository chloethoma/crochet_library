...
export const getAllData = async () => {
    const res = await fetch('https://crochet-library-dev-zjtn.3.us-1.fl0.io/api/all');
...
export const getItemData = async (itemId) => {
    const res = await fetch(`https://crochet-library-dev-zjtn.3.us-1.fl0.io/api/item/${itemId}`);
